...
def cluster_embeddings_lemon(embeddings, k, random_state=0):
    ...
    km = KMeans(n_clusters=valid_k, n_init=20, random_state=random_state, algorithm='lloyd')
...
def perform_keamns(df_ready_for_cluster, n_clusters):
    ...
    km = KMeans(n_clusters=valid_k, random_state=42, n_init=20, algorithm='lloyd')
