...
class OverlayWorker(QThread):
    ...
    def run(self):
            ...
            try:
                ...
                err_msg = str(e)
                print(f"[OverlayWorker] Error occurred: {err_msg}")
...
class OverlayWidget(QFrame):
    ...
    def _on_worker_error(self, error_message):
        print(f"[OverlayWidget] Error from worker: {error_message}")
        self.lbl_thumbnail.setText("Error processing image")
        self.lbl_thumbnail.setStyleSheet("color: red;")
